...
## [0.1.0-rc.1](https://github.com/heywhy/expert/compare/v0.1.0-rc.5...v0.1.0-rc.1) (2026-02-28)
...
* add `instance_id` metadata to logs ([#380](https://github.com/heywhy/expert/issues/380)) ([5c209be](https://github.com/heywhy/expert/commit/5c209be7490c44be6c3c12ca13058ddc16b91912))
...
* **engine:** hover for module attributes ([#329](https://github.com/heywhy/expert/issues/329)) ([1330370](https://github.com/heywhy/expert/commit/1330370cfa5693e246cba4a381e1948e6a090ff0))
* **engine:** indicate progress when loading checkpoint ([#313](https://github.com/heywhy/expert/issues/313)) ([fad5a0b](https://github.com/heywhy/expert/commit/fad5a0b24eefaaf14ddc73b52ea2f66711083492))
...
* **engine:** use ElixirSense for hover resolution ([#351](https://github.com/heywhy/expert/issues/351)) ([0e7896b](https://github.com/heywhy/expert/commit/0e7896bdc48d07d46eb6e2e8e842cefe6c019cba))
...
* prompt user to fetch deps when they get out of sync ([#405](https://github.com/heywhy/expert/issues/405)) ([fc16ddc](https://github.com/heywhy/expert/commit/fc16ddc14395817766f9ac9c902dde08d6e63f7d))
* use Spitfire to provide document symbols on documents with syntax errors ([#288](https://github.com/heywhy/expert/issues/288)) ([2ed7a81](https://github.com/heywhy/expert/commit/2ed7a81e2361ac56933dff8be494675313972cb6))
...
* build engines to `:user_cache` instead of `:user_data` ([#467](https://github.com/heywhy/expert/issues/467)) ([5c65a97](https://github.com/heywhy/expert/commit/5c65a97bf2695d9ed367248ac53750e8b4930dfb))
* build expert on latest nixpkgs ([#422](https://github.com/heywhy/expert/issues/422)) ([d3eb92c](https://github.com/heywhy/expert/commit/d3eb92cf16ef154ddd7cd08d1135fd9d44c8bff0))
* bump spitfire v0.3.7 ([#425](https://github.com/heywhy/expert/issues/425)) ([ce508c8](https://github.com/heywhy/expert/commit/ce508c868efe8cc1ca07299f9dda249be7df3525))
...
* **cli:** don't crash when there is no CLI arg provided ([#348](https://github.com/heywhy/expert/issues/348)) ([9a9140e](https://github.com/heywhy/expert/commit/9a9140ed921c28a14663923be7a2331e00764f71))
...
* correctly handle port lines when building the engine ([#463](https://github.com/heywhy/expert/issues/463)) ([d795c70](https://github.com/heywhy/expert/commit/d795c70982a8ab39a06b91c72942ea7988c03657))
* correctly order aliases ([#322](https://github.com/heywhy/expert/issues/322)) ([fb269fa](https://github.com/heywhy/expert/commit/fb269fac05de62fff21cd05f0dc1917729953753))
...
* **deps:** update sourceror to 1.10.1 to fix range calculations ([#362](https://github.com/heywhy/expert/issues/362)) ([59489c7](https://github.com/heywhy/expert/commit/59489c75437307c61f544f2dfae2201e03b00f70))
...
* **engine:** avoid duplicate spec annotation when falling back to ElixirSense ([#410](https://github.com/heywhy/expert/issues/410)) ([5b4faee](https://github.com/heywhy/expert/commit/5b4faee7943b36e62890c4ae1143ce46f37db839))
...
* **engine:** correctly match any-struct references ([#347](https://github.com/heywhy/expert/issues/347)) ([6a92581](https://github.com/heywhy/expert/commit/6a925814d74b1bac39e60f4a1ee6e4689e8a90a1))
...
* **engine:** don't collect sibling scopes in Phoenix router ([#420](https://github.com/heywhy/expert/issues/420)) ([b72bfc8](https://github.com/heywhy/expert/commit/b72bfc839a372138abbc30ac9cef3c1f6625ff81))
* **engine:** don't crash on hover for piped expression in curly braces in HEEx ([#350](https://github.com/heywhy/expert/issues/350)) ([f0044d6](https://github.com/heywhy/expert/commit/f0044d6b6442f4308bb4b3854012f982bfc7077b))
* **engine:** don't crash when calling references on an atom ([#396](https://github.com/heywhy/expert/issues/396)) ([a8badfc](https://github.com/heywhy/expert/commit/a8badfcf99a83856475a278d9365730a8e1ab842))
* **engine:** don't terminate search store on timeout ([#338](https://github.com/heywhy/expert/issues/338)) ([d91f6af](https://github.com/heywhy/expert/commit/d91f6af0fb7c78a9da1aa0c83787783dee94507e)), closes [#303](https://github.com/heywhy/expert/issues/303)
* **engine:** download Hex and Rebar only if missing ([#337](https://github.com/heywhy/expert/issues/337)) ([bc7f57e](https://github.com/heywhy/expert/commit/bc7f57e1f5802fc71ce2958529e45eabac005ff9))
...
* **engine:** handle matches against any struct ([#343](https://github.com/heywhy/expert/issues/343)) ([86fe8ec](https://github.com/heywhy/expert/commit/86fe8ec2168c266631e7f3506fcbf0afa6083656))
* **engine:** improve entity resolution for HEEx components with curly braces ([#328](https://github.com/heywhy/expert/issues/328)) ([eff68bf](https://github.com/heywhy/expert/commit/eff68bf31a8466fb65664f3447c7274166cbf5d5))
* **engine:** index functions with default arguments ([#402](https://github.com/heywhy/expert/issues/402)) ([1aea6c7](https://github.com/heywhy/expert/commit/1aea6c7c36d7c864f2295c5ab01d10f7315a10bb))
* **engine:** resolve correct arity from inside ~H sigil ([#314](https://github.com/heywhy/expert/issues/314)) ([d2eacc0](https://github.com/heywhy/expert/commit/d2eacc09737c279a476f0eefbcd2cbc07a6d850b))
* **engine:** skip unquoted aliases ([#452](https://github.com/heywhy/expert/issues/452)) ([9c5c89a](https://github.com/heywhy/expert/commit/9c5c89a1e4ebbd457e4a5d5b59eebf8d827508a4))
* **engine:** stuck on format request ([#378](https://github.com/heywhy/expert/issues/378)) ([aa5ba2b](https://github.com/heywhy/expert/commit/aa5ba2b92174d75b27dfcb96592b678ad7a62636))
...
* ensure `MIX_BUILD_PATH` is set for child processes ([#436](https://github.com/heywhy/expert/issues/436)) ([3178302](https://github.com/heywhy/expert/commit/31783023c9ba4b0152a76aa255572867cca1abe7))
...
* **expert:** always log PATH on start ([#387](https://github.com/heywhy/expert/issues/387)) ([bfeb8a2](https://github.com/heywhy/expert/commit/bfeb8a27f341f6da3caf20d0f8054901080143ef))
* **expert:** always use MIX_ENV=dev when building engine ([#442](https://github.com/heywhy/expert/issues/442)) ([60cc5b7](https://github.com/heywhy/expert/commit/60cc5b720cfd1860fe66d54a7ee23257b87acae4)), closes [#431](https://github.com/heywhy/expert/issues/431)
* **expert:** build engine for elixir version 1.16.1 and below ([#330](https://github.com/heywhy/expert/issues/330)) ([2a2bdd9](https://github.com/heywhy/expert/commit/2a2bdd916e76340f8d60939a7b5160ffaf24c4e0))
* **expert:** check start_child return in initialized handler ([#371](https://github.com/heywhy/expert/issues/371)) ([de979ce](https://github.com/heywhy/expert/commit/de979ceabaa108a3e5eb43a7675f13ac913ac76b))
* **expert:** correctly handle unicode characters sent via port ([#388](https://github.com/heywhy/expert/issues/388)) ([4fe530b](https://github.com/heywhy/expert/commit/4fe530be71893e30a99ff7eacd48ddb2da44eba3))
* **expert:** don't crash on missing root_uri ([#412](https://github.com/heywhy/expert/issues/412)) ([11ed716](https://github.com/heywhy/expert/commit/11ed7167a5007075c254b38fbe72586afbfe6b65))
* **expert:** honor users PATH ([#456](https://github.com/heywhy/expert/issues/456)) ([c003eba](https://github.com/heywhy/expert/commit/c003eba58d2ef60121b29c8d05071156f520ec7d))
...
* **expert:** send correct version in server_info ([#457](https://github.com/heywhy/expert/issues/457)) ([31a4226](https://github.com/heywhy/expert/commit/31a4226d48c2e21514115decd7120d8174201b5c))
* **expert:** spec completions for functions with guards ([#406](https://github.com/heywhy/expert/issues/406)) ([d615858](https://github.com/heywhy/expert/commit/d615858f8de28a88b53e8786da243fe3feb5e3d5))
...
* filter out RELEASE_ROOT from PATH instead of running a login shell ([#344](https://github.com/heywhy/expert/issues/344)) ([375391c](https://github.com/heywhy/expert/commit/375391c92c8027e06e0c293325384e6c58310a6f))
...
* **forge:** don't crash on analysis of code with incorrect aliases ([#408](https://github.com/heywhy/expert/issues/408)) ([7c30502](https://github.com/heywhy/expert/commit/7c3050216340c55cef92bc86414b791b3889bcfa))
* **forge:** fix parent check to not give false positive on some siblings ([#472](https://github.com/heywhy/expert/issues/472)) ([44a43e2](https://github.com/heywhy/expert/commit/44a43e2d146ddb1a5cd9cce35b5cd7cd8947a94f))
* **forge:** handle interpolation when it starts with a special token ([#342](https://github.com/heywhy/expert/issues/342)) ([dd7b027](https://github.com/heywhy/expert/commit/dd7b02765635c0cadaa6fe55f86dc5e334e0bada))
* **forge:** improve log when Spitfire crashes ([#352](https://github.com/heywhy/expert/issues/352)) ([80900e5](https://github.com/heywhy/expert/commit/80900e56c8685ca7b85951b091fa624ea1950ee2))
* **forge:** progress message ordering ([#427](https://github.com/heywhy/expert/issues/427)) ([f3b9187](https://github.com/heywhy/expert/commit/f3b9187911da7906131b2f96406c3a1f7e95bd74))
...
* forward logs through window log handler ([#418](https://github.com/heywhy/expert/issues/418)) ([c608dc8](https://github.com/heywhy/expert/commit/c608dc84597193a2875714636ad2eebf40820ad5)), closes [#382](https://github.com/heywhy/expert/issues/382)
...
* handle missing metadata in indexer extractors ([#390](https://github.com/heywhy/expert/issues/390)) ([71c33f1](https://github.com/heywhy/expert/commit/71c33f10ba8ab566a4e12dba024dba3e8c6f7c73))
* handle spitfire crashes ([#319](https://github.com/heywhy/expert/issues/319)) ([ffe360c](https://github.com/heywhy/expert/commit/ffe360c88e8811e41fbd33d6404acb18f4b7a95e))
...
* interpolation_ranges/1 should work for empty interpolations ([#321](https://github.com/heywhy/expert/issues/321)) ([3ec1810](https://github.com/heywhy/expert/commit/3ec1810e397bea76d84daa6816a5061d39cc480f))
...
* isolate engine builds and retry them on dependency errors ([#454](https://github.com/heywhy/expert/issues/454)) ([3205d56](https://github.com/heywhy/expert/commit/3205d5649b94c88db138175a3e6a79fd47d174cb))
...
* log project's erl path ([#367](https://github.com/heywhy/expert/issues/367)) ([d8c81cd](https://github.com/heywhy/expert/commit/d8c81cd5c686e770d35bcd10ede3980a733e1471))
* make Refactorex available on all trigger kinds ([#445](https://github.com/heywhy/expert/issues/445)) ([97c810b](https://github.com/heywhy/expert/commit/97c810bf8a7d4522a75e13bd1cdcee7adf07d8bd))
...
* migrate expert runtime logging to OTP handlers ([#419](https://github.com/heywhy/expert/issues/419)) ([8f2dda5](https://github.com/heywhy/expert/commit/8f2dda5f03de40419d10bd88b3072176c868f7c3))
...
* properly setup logger ([#455](https://github.com/heywhy/expert/issues/455)) ([ba10ae8](https://github.com/heywhy/expert/commit/ba10ae87cae1247a47ae26106161c599fefae1f4))
* provide typespec docs on hover for private functions ([#407](https://github.com/heywhy/expert/issues/407)) ([79c5451](https://github.com/heywhy/expert/commit/79c54513b8bb1a9e1eff2f7c32d4ff8354c8d0fa))
...
* remove all usages of epmd ([#339](https://github.com/heywhy/expert/issues/339)) ([cef4adb](https://github.com/heywhy/expert/commit/cef4adb13bfb9e697892f421ebdd949b87c10084))
...
* resolve function delegates on hover docs ([#399](https://github.com/heywhy/expert/issues/399)) ([a3c629a](https://github.com/heywhy/expert/commit/a3c629a8e3cbabf2badd494695a614b2e8a389ae))
...
* sanitize node names ([#323](https://github.com/heywhy/expert/issues/323)) ([7591304](https://github.com/heywhy/expert/commit/7591304e94d3421db7788544fa7e8b382a393f6d))
...
* support multiple elixir versions on multiroot projects ([#413](https://github.com/heywhy/expert/issues/413)) ([dee595d](https://github.com/heywhy/expert/commit/dee595d9040416f9036eaa355ac645a8f35da202))
...
* update document store on didchange even without the engine running ([#326](https://github.com/heywhy/expert/issues/326)) ([c80b72d](https://github.com/heywhy/expert/commit/c80b72d05d9ee8c04efde6402c65a552306bf07a))
* update gen_lsp to 0.11.3 ([#315](https://github.com/heywhy/expert/issues/315)) ([13cfee6](https://github.com/heywhy/expert/commit/13cfee67150d562e2f97bcf4a558946c2aafd7b6)), closes [#245](https://github.com/heywhy/expert/issues/245)
* update spitfire to v0.3.4 ([#373](https://github.com/heywhy/expert/issues/373)) ([6f57f16](https://github.com/heywhy/expert/commit/6f57f1648c61fd5deaa3212f385205f52696f6f3))
* update spitfire to v0.3.5 ([#376](https://github.com/heywhy/expert/issues/376)) ([85822fe](https://github.com/heywhy/expert/commit/85822fe7c7d32c47e47b211fb94c0493a35d0bf8))
* use Calendar.UTCOnlyTimeZoneDatabase instead of project configured tz database ([#324](https://github.com/heywhy/expert/issues/324)) ([9e913f6](https://github.com/heywhy/expert/commit/9e913f640ba31e3dd36f5615da2e6e68e10a5d2e))
...
* release as 0.1.0-rc.0 ([c98b870](https://github.com/heywhy/expert/commit/c98b870fc073656cb955defda8b8623f71d2abc8))
* release as 0.1.0-rc.1 ([6f5986e](https://github.com/heywhy/expert/commit/6f5986eced5090b2df17b0c0cb659180eafd047a))
...
* add engine subcommands to expert ([#254](https://github.com/elixir-lang/expert/issues/254)) ([d7c348c](https://github.com/elixir-lang/expert/commit/d7c348cd5682dd0fd5fef04b56e8d9058b76ced6))
* add missing require code action ([#283](https://github.com/elixir-lang/expert/issues/283)) ([a9ee0ec](https://github.com/elixir-lang/expert/commit/a9ee0ec8617f8bee70aa9d1431ff4d4930a8fb29))
* configure Workspace Symbols to return all symbols on empty query ([#293](https://github.com/elixir-lang/expert/issues/293)) ([03ec5c6](https://github.com/elixir-lang/expert/commit/03ec5c6cd614bc17c7ec3d68d1cf5f7c2ed185bb))
* create undefined function code action ([#287](https://github.com/elixir-lang/expert/issues/287)) ([9624b3a](https://github.com/elixir-lang/expert/commit/9624b3ab1010b15d6cbb5d238d26a1a922936fbb))
* **engine:** hover for module attributes ([#329](https://github.com/elixir-lang/expert/issues/329)) ([1330370](https://github.com/elixir-lang/expert/commit/1330370cfa5693e246cba4a381e1948e6a090ff0))
* **engine:** indicate progress when loading checkpoint ([#313](https://github.com/elixir-lang/expert/issues/313)) ([fad5a0b](https://github.com/elixir-lang/expert/commit/fad5a0b24eefaaf14ddc73b52ea2f66711083492))
* **engine:** support shorthand notation inside ~H sigil ([#278](https://github.com/elixir-lang/expert/issues/278)) ([e1e5666](https://github.com/elixir-lang/expert/commit/e1e5666dafccc24b1116eed8ad20a34cf667e9b8))
* **engine:** use ElixirSense for hover resolution ([#351](https://github.com/elixir-lang/expert/issues/351)) ([0e7896b](https://github.com/elixir-lang/expert/commit/0e7896bdc48d07d46eb6e2e8e842cefe6c019cba))
...
* use Spitfire to provide document symbols on documents with syntax errors ([#288](https://github.com/elixir-lang/expert/issues/288)) ([2ed7a81](https://github.com/elixir-lang/expert/commit/2ed7a81e2361ac56933dff8be494675313972cb6))
...
* workspace folders ([#18](https://github.com/elixir-lang/expert/issues/18)) ([1204313](https://github.com/elixir-lang/expert/commit/1204313371da69029eb275235254f4d67905fa47)), closes [#136](https://github.com/elixir-lang/expert/issues/136)
...
* avoid crashing when calling `ActiveProjects.active?/1` ([#297](https://github.com/elixir-lang/expert/issues/297)) ([ae352b9](https://github.com/elixir-lang/expert/commit/ae352b98d739b37c6c9d5d63ad29c069425794ef))
...
* **cli:** don't crash when there is no CLI arg provided ([#348](https://github.com/elixir-lang/expert/issues/348)) ([9a9140e](https://github.com/elixir-lang/expert/commit/9a9140ed921c28a14663923be7a2331e00764f71))
* **cli:** show per tool version engine builds ([#301](https://github.com/elixir-lang/expert/issues/301)) ([399b2a0](https://github.com/elixir-lang/expert/commit/399b2a093e464446b14facccc16f2a073265d499))
* correctly order aliases ([#322](https://github.com/elixir-lang/expert/issues/322)) ([fb269fa](https://github.com/elixir-lang/expert/commit/fb269fac05de62fff21cd05f0dc1917729953753))
...
* **deps:** update sourceror to 1.10.1 to fix range calculations ([#362](https://github.com/elixir-lang/expert/issues/362)) ([59489c7](https://github.com/elixir-lang/expert/commit/59489c75437307c61f544f2dfae2201e03b00f70))
...
* **engine_node:** error reason not being shown ([#277](https://github.com/elixir-lang/expert/issues/277)) ([c7b7fa8](https://github.com/elixir-lang/expert/commit/c7b7fa849ca1786f62ba2d5bdb034526fae796f0))
* **engine:** avoid duplicate spec annotation when falling back to ElixirSense ([#410](https://github.com/elixir-lang/expert/issues/410)) ([5b4faee](https://github.com/elixir-lang/expert/commit/5b4faee7943b36e62890c4ae1143ce46f37db839))
* **engine:** code lens exception when mix.exs not found ([#281](https://github.com/elixir-lang/expert/issues/281)) ([f9c81da](https://github.com/elixir-lang/expert/commit/f9c81da38640240e81aa97d51d1ed8ccaee08696))
* **engine:** correctly match any-struct references ([#347](https://github.com/elixir-lang/expert/issues/347)) ([6a92581](https://github.com/elixir-lang/expert/commit/6a925814d74b1bac39e60f4a1ee6e4689e8a90a1))
* **engine:** don't attempt search when ETS checkpoint is loading ([#308](https://github.com/elixir-lang/expert/issues/308)) ([438c965](https://github.com/elixir-lang/expert/commit/438c965ce6943651688e3349b782d64b2459a6c2))
* **engine:** don't crash on hover for piped expression in curly braces in HEEx ([#350](https://github.com/elixir-lang/expert/issues/350)) ([f0044d6](https://github.com/elixir-lang/expert/commit/f0044d6b6442f4308bb4b3854012f982bfc7077b))
* **engine:** don't crash when calling references on an atom ([#396](https://github.com/elixir-lang/expert/issues/396)) ([a8badfc](https://github.com/elixir-lang/expert/commit/a8badfcf99a83856475a278d9365730a8e1ab842))
* **engine:** don't terminate search store on timeout ([#338](https://github.com/elixir-lang/expert/issues/338)) ([d91f6af](https://github.com/elixir-lang/expert/commit/d91f6af0fb7c78a9da1aa0c83787783dee94507e)), closes [#303](https://github.com/elixir-lang/expert/issues/303)
* **engine:** download Hex and Rebar only if missing ([#337](https://github.com/elixir-lang/expert/issues/337)) ([bc7f57e](https://github.com/elixir-lang/expert/commit/bc7f57e1f5802fc71ce2958529e45eabac005ff9))
...
* **engine:** handle matches against any struct ([#343](https://github.com/elixir-lang/expert/issues/343)) ([86fe8ec](https://github.com/elixir-lang/expert/commit/86fe8ec2168c266631e7f3506fcbf0afa6083656))
* **engine:** improve entity resolution for HEEx components with curly braces ([#328](https://github.com/elixir-lang/expert/issues/328)) ([eff68bf](https://github.com/elixir-lang/expert/commit/eff68bf31a8466fb65664f3447c7274166cbf5d5))
* **engine:** index functions with default arguments ([#402](https://github.com/elixir-lang/expert/issues/402)) ([1aea6c7](https://github.com/elixir-lang/expert/commit/1aea6c7c36d7c864f2295c5ab01d10f7315a10bb))
* **engine:** resolve correct arity from inside ~H sigil ([#314](https://github.com/elixir-lang/expert/issues/314)) ([d2eacc0](https://github.com/elixir-lang/expert/commit/d2eacc09737c279a476f0eefbcd2cbc07a6d850b))
* **engine:** stuck on format request ([#378](https://github.com/elixir-lang/expert/issues/378)) ([aa5ba2b](https://github.com/elixir-lang/expert/commit/aa5ba2b92174d75b27dfcb96592b678ad7a62636))
...
* **expert:** always log PATH on start ([#387](https://github.com/elixir-lang/expert/issues/387)) ([bfeb8a2](https://github.com/elixir-lang/expert/commit/bfeb8a27f341f6da3caf20d0f8054901080143ef))
* **expert:** build engine for elixir version 1.16.1 and below ([#330](https://github.com/elixir-lang/expert/issues/330)) ([2a2bdd9](https://github.com/elixir-lang/expert/commit/2a2bdd916e76340f8d60939a7b5160ffaf24c4e0))
* **expert:** correctly handle unicode characters sent via port ([#388](https://github.com/elixir-lang/expert/issues/388)) ([4fe530b](https://github.com/elixir-lang/expert/commit/4fe530be71893e30a99ff7eacd48ddb2da44eba3))
* **expert:** print to stderr when no transport argument provided ([#280](https://github.com/elixir-lang/expert/issues/280)) ([fc841e4](https://github.com/elixir-lang/expert/commit/fc841e48be753a5b72e1464c110226dd5f745471))
* **expert:** save new configuration after `workspace/didChangeConfiguration` ([#282](https://github.com/elixir-lang/expert/issues/282)) ([b060d23](https://github.com/elixir-lang/expert/commit/b060d2356f74ad510bb774e4c6be0a5fb5646be3))
* **expert:** spec completions for functions with guards ([#406](https://github.com/elixir-lang/expert/issues/406)) ([d615858](https://github.com/elixir-lang/expert/commit/d615858f8de28a88b53e8786da243fe3feb5e3d5))
* fallback to packaged or system elixir ([#300](https://github.com/elixir-lang/expert/issues/300)) ([10262cf](https://github.com/elixir-lang/expert/commit/10262cf4bf5541e96d1496ba160a7700ab5dc359))
* filter out RELEASE_ROOT from PATH instead of running a login shell ([#344](https://github.com/elixir-lang/expert/issues/344)) ([375391c](https://github.com/elixir-lang/expert/commit/375391c92c8027e06e0c293325384e6c58310a6f))
...
* **forge:** don't crash on analysis of code with incorrect aliases ([#408](https://github.com/elixir-lang/expert/issues/408)) ([7c30502](https://github.com/elixir-lang/expert/commit/7c3050216340c55cef92bc86414b791b3889bcfa))
* **forge:** handle interpolation when it starts with a special token ([#342](https://github.com/elixir-lang/expert/issues/342)) ([dd7b027](https://github.com/elixir-lang/expert/commit/dd7b02765635c0cadaa6fe55f86dc5e334e0bada))
* **forge:** improve log when Spitfire crashes ([#352](https://github.com/elixir-lang/expert/issues/352)) ([80900e5](https://github.com/elixir-lang/expert/commit/80900e56c8685ca7b85951b091fa624ea1950ee2))
...
* handle missing metadata in indexer extractors ([#390](https://github.com/elixir-lang/expert/issues/390)) ([71c33f1](https://github.com/elixir-lang/expert/commit/71c33f10ba8ab566a4e12dba024dba3e8c6f7c73))
* handle spitfire crashes ([#319](https://github.com/elixir-lang/expert/issues/319)) ([ffe360c](https://github.com/elixir-lang/expert/commit/ffe360c88e8811e41fbd33d6404acb18f4b7a95e))
...
* inherited PATH pollutes project environment ([#298](https://github.com/elixir-lang/expert/issues/298)) ([8e1bb3d](https://github.com/elixir-lang/expert/commit/8e1bb3dc5328ddc6fcab2203767b44a92db0909a))
* interpolation_ranges/1 should work for empty interpolations ([#321](https://github.com/elixir-lang/expert/issues/321)) ([3ec1810](https://github.com/elixir-lang/expert/commit/3ec1810e397bea76d84daa6816a5061d39cc480f))
...
* log project's erl path ([#367](https://github.com/elixir-lang/expert/issues/367)) ([d8c81cd](https://github.com/elixir-lang/expert/commit/d8c81cd5c686e770d35bcd10ede3980a733e1471))
...
* remove all usages of epmd ([#339](https://github.com/elixir-lang/expert/issues/339)) ([cef4adb](https://github.com/elixir-lang/expert/commit/cef4adb13bfb9e697892f421ebdd949b87c10084))
...
* resolve function delegates on hover docs ([#399](https://github.com/elixir-lang/expert/issues/399)) ([a3c629a](https://github.com/elixir-lang/expert/commit/a3c629a8e3cbabf2badd494695a614b2e8a389ae))
...
* sanitize node names ([#323](https://github.com/elixir-lang/expert/issues/323)) ([7591304](https://github.com/elixir-lang/expert/commit/7591304e94d3421db7788544fa7e8b382a393f6d))
* start projects after server is initialized ([#294](https://github.com/elixir-lang/expert/issues/294)) ([76d6cd5](https://github.com/elixir-lang/expert/commit/76d6cd5570232f5725456356c9c4d29e2db090d1))
...
* support mise et al on windows ([#304](https://github.com/elixir-lang/expert/issues/304)) ([3cc343f](https://github.com/elixir-lang/expert/commit/3cc343fd8dc63cd78be84f21a0aec6f8a5afc79d))
* support Nushell for PATH detection ([#272](https://github.com/elixir-lang/expert/issues/272)) ([8a9fd3d](https://github.com/elixir-lang/expert/commit/8a9fd3dbd3552a9378548807b5d13f306ec4a92e))
...
* update document store on didchange even without the engine running ([#326](https://github.com/elixir-lang/expert/issues/326)) ([c80b72d](https://github.com/elixir-lang/expert/commit/c80b72d05d9ee8c04efde6402c65a552306bf07a))
* update gen_lsp to 0.11.3 ([#315](https://github.com/elixir-lang/expert/issues/315)) ([13cfee6](https://github.com/elixir-lang/expert/commit/13cfee67150d562e2f97bcf4a558946c2aafd7b6)), closes [#245](https://github.com/elixir-lang/expert/issues/245)
* update spitfire to v0.3.4 ([#373](https://github.com/elixir-lang/expert/issues/373)) ([6f57f16](https://github.com/elixir-lang/expert/commit/6f57f1648c61fd5deaa3212f385205f52696f6f3))
* update spitfire to v0.3.5 ([#376](https://github.com/elixir-lang/expert/issues/376)) ([85822fe](https://github.com/elixir-lang/expert/commit/85822fe7c7d32c47e47b211fb94c0493a35d0bf8))
* use Calendar.UTCOnlyTimeZoneDatabase instead of project configured tz database ([#324](https://github.com/elixir-lang/expert/issues/324)) ([9e913f6](https://github.com/elixir-lang/expert/commit/9e913f640ba31e3dd36f5615da2e6e68e10a5d2e))
...
* use minimal PATH on unix instead of fully removing it ([#305](https://github.com/elixir-lang/expert/issues/305)) ([74da1a5](https://github.com/elixir-lang/expert/commit/74da1a568dd741fca381c9bb9019127556640a79))
...
* release as 0.1.0-rc.0 ([c98b870](https://github.com/elixir-lang/expert/commit/c98b870fc073656cb955defda8b8623f71d2abc8))
